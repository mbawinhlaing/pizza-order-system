...
Route::middleware(['auth'])->group(function () {
    ...
    //Admin
    // Route::prefix(['middleware'=>'admin_auth','prefix'=>'category','namespace'=>'admin'])->group(function () {
    ...
    Route::middleware(['admin_auth'])->group(function(){
        ...
        Route::prefix('admin')->group(function(){
            ...
            //Account Profile
            Route::get('details',[AdminController::class,'details'])->name('admin#deails');
        ...
        Route::prefix('order')->group(function(){
            ...
            Route::get('listInfor/{orderCode}',[OrderController::class,'listInfo'])->name('admin#listInfo');
        });
           //User List
    ...
    Route::group(['prefix'=>'user', 'middleware'=>'user_auth'], function(){
        ...
        Route::prefix('pizza')->group(function(){
            Route::get('detials/{id}',[UserController::class,'pizzaDetails'])->name('user#pizzaDetails');
        });
